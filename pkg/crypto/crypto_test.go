...
func Test_Hash(t *testing.T) {
	...
	t.Run("Can detect unequal hashes", should_be_able_to_hash_and_compare_strings)
	t.Run("Generate a different salt every run", should_return_error_when_comparing_unequal_hashes)
}
